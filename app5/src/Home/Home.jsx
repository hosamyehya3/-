...
import { faBookOpen ,faArrowsRotate ,faBullseye  ,faCircle ,faHandshake ,faBolt , faPenNib , faNewspaper , faUsers } from '@fortawesome/free-solid-svg-icons';
...
export default function Home() {
  ...
  return <>
    <div className='bg-black  relative w-full  h-[100%]'>
      <section className="relative py-24 overflow-hidden">
        ...
        <div className="relative my-20 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <span className="section-label py-2 text-orange-600 inline-flex border border-orange-800 font-bold items-center gap-2 mb-6">
              من نحن    <span className="w-2 h-2 bg-orange-500  rounded-full animate-pulse">
              </span>
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6">مهمتنا هي <span className="gradient-text">الإعلام والإلهام</span></h1>
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4 max-w-4xl mx-auto"><div className="glass-card p-6"><FontAwesomeIcon className='text-[25px] color text-orange-500'  icon={faUsers} />
                <div className="text-3xl font-bold gradient-text mb-1">+2مليون</div>
                <div className="text-sm text-neutral-500">قارئ شهرياً</div></div><div className="glass-card p-6"><FontAwesomeIcon className='text-[25px] color text-orange-500'  icon={faNewspaper} />
                <div className="text-3xl font-bold gradient-text mb-1">+500</div>
                <div className="text-sm text-neutral-500">مقالة منشورة</div></div>
                <div className="glass-card p-6"><FontAwesomeIcon className='text-[25px] color text-orange-500'  icon={faPenNib} />
                <div className="text-3xl font-bold gradient-text mb-1">+50</div>
                <div className="text-sm text-neutral-500">كاتب خبير</div>
                </div>
                <div className="glass-card p-6"> <FontAwesomeIcon className='text-[25px] color text-orange-500'  icon={faBookOpen} />
                <div className="text-3xl font-bold gradient-text mb-1">+15</div><div className="text-sm text-neutral-500">تصنيف</div>
                </div>
                </div>
                </div>
                </section>
...
<div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
  <div className="text-center mb-16">
    <h2 className="text-3xl md:text-4xl font-bold text-white mb-4 flex items-center justify-center gap-3"><span className="w-1.5 h-8 bg-gradient-to-b from-orange-500 to-yellow-500 rounded-full"></span>قيمنا<span className="w-1.5 h-8 bg-gradient-to-b from-yellow-500 to-orange-500 rounded-full"></span>
    </h2>
    ...
    <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
      ...
      <div className="absolute inset-0 bg-gradient-to-br from-orange-500 to-yellow-500 opacity-0 group-hover:opacity-10 transition-opacity duration-300">
        ...
        <div className="relative">
          <FontAwesomeIcon className= 'mb-4 text-[40px] color text-orange-500'  icon={faBullseye} />
          ...
          <div className="relative">
            <FontAwesomeIcon className='mb-4 text-[40px] color text-orange-500'  icon={faBolt} />
            ...
            <div className="absolute inset-0 bg-gradient-to-br from-orange-500 to-yellow-500 opacity-0 group-hover:opacity-10 transition-opacity duration-300">
              ...
              <div className="relative">
              <FontAwesomeIcon className='mb-4 text-[40px] color text-orange-500'  icon={faHandshake} />
                ...
                <div className="absolute inset-0 bg-gradient-to-br from-orange-600 to-orange-400 opacity-0 group-hover:opacity-10 transition-opacity duration-300">
                  ...
                  <div className="relative">
                     <FontAwesomeIcon className='text-[40px] color text-orange-500 mb-4'  icon={faArrowsRotate} />
                ...
                <section className='bg-black py-20'>
                  <div className='max-w-6xl mx-auto px-4 sm:px-6 lg:px-8'>
                    <div className='text-center mb-16'>
                      <span className=" section-label  text-orange-500 ">
                        فريقنا
                        <FontAwesomeIcon className= 'ms-2 animate-pulse mb-[2px] text-[10px] color text-orange-500'  icon={faCircle} />
                         </span>
                      <h2 className="mt-5 text-3xl md:text-4xl font-bold text-white mb-4">تعرف على كتابنا</h2>
...
<section className="py-28 bg-gradient-to-br from-orange-600 via-orange-500 to-yellow-500 relative overflow-hidden">
  <div className=" absolute inset-0 opacity-30">
