...
let [numbercards , setnumbercards] = useState(28)
  ...
  let [card, setcard] = useState(arr)
  let newcard = structuredClone(arr)
  let anthorarray = newcard.splice(6)
  let result = anthorarray.splice(6)
  ...
  function changeTwo() {
    setCurrentPage(2)
    console.log(anthorarray);
    anthorarray.splice(6)
    setcard(anthorarray)
...
function lighting(){
let result1= arr.filter((onebyone)=>{return onebyone.category== "إضاءة"})
  console.log(result);
  setcard(result1)
  setnumbercards(result1.length)
}
function port(){
  let result2= arr.filter((onebyone)=>{return onebyone.category== "بورتريه"})
  setcard(result2)
  setnumbercards(result2.length)
}
function nature(){
  let result3= arr.filter((onebyone)=>{return onebyone.category== "مناظر طبيعية"})
  setcard(result3)
  
    setnumbercards(result3.length)

}
function tools (){
  let result4= arr.filter((onebyone)=>{return onebyone.category== "تقنيات"})
  setcard(result4)
      setnumbercards(result4.length)


}
function equipment (){
  let result5= arr.filter((onebyone)=>{return onebyone.category== "معدات"})
  setcard(result5)
      setnumbercards(result5.length)

}
function allcards(){
    let result6= arr.filter((onebyone)=>{return onebyone})
  setcard(result6)
  ...
  return <>
    <div className="min-h-screen py-20 bg-[#0a0a0a]">
      <div className="relative py-20 overflow-hidden">
        ...
        <div className="absolute inset-0">
        ...
        </div><div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <span className="text-orange-500 direction section-label inline-flex items-center gap-2 mb-6">
            <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M19 20H5a2 2 0 01-2-2V6a2 2 0 012-2h10a2 2 0 012 2v1m2 13a2 2 0 01-2-2V7m2 13a2 2 0 002-2V9a2 2 0 00-2-2h-2m-4-3H9M7 16h6M7 8h6v4H7V8z"></path></svg>مدونتنا</span>
          ...
          <p className="text-xl text-neutral-400 max-w-2xl mx-auto">اكتشف الدروس والرؤى وأفضل الممارسات للتطوير الحديث</p></div>
      </div>
      <div className="sticky top-20 z-40 bg-[#0a0a0a]/90 backdrop-blur-xl border-b border-[#262626]">
        <div className="max-w-7xl  direction mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <div className="relative w-full md:w-80">
              <input placeholder="ابحث في المقالات..." className="input-dark w-full px-5 py-3 pr-12" type="text" />
            ...
            <div className="flex flex-wrap justify-center gap-2">
              <button onClick={allcards} className="px-4 py-2 rounded-xl text-sm font-medium transition-all duration-300 bg-[#161616] text-neutral-400 border border-[#262626] hover:border-orange-500/30">جميع المقالات</button>
              <button onClick={lighting} className="px-4 py-2 rounded-xl text-sm font-medium transition-all duration-300 bg-[#161616] text-neutral-400 border border-[#262626] hover:border-orange-500/30">إضاءة</button>
              <button onClick={port} className="px-4 py-2 rounded-xl text-sm font-medium transition-all duration-300 bg-[#161616] text-neutral-400 border border-[#262626] hover:border-orange-500/30">بورتريه</button>
              <button onClick={nature} className="px-4 py-2 rounded-xl text-sm font-medium transition-all duration-300 bg-[#161616] text-neutral-400 border border-[#262626] hover:border-orange-500/30">مناظر طبيعية</button>
              <button onClick={tools} className="px-4 py-2 rounded-xl text-sm font-medium transition-all duration-300 bg-[#161616] text-neutral-400 border border-[#262626] hover:border-orange-500/30">تقنيات</button>
              <button onClick={equipment}  className="px-4 py-2 rounded-xl text-sm font-medium transition-all duration-300 bg-[#161616] text-neutral-400 border border-[#262626] hover:border-orange-500/30">معدات</button>
            </div>
          </div>
        </div>
      </div>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 scroll-mt-[146px]">
        <div className="mb-8 flex items-center justify-between">
          <p className="text-neutral-400">عرض <span className="font-bold text-white">{numbercards}</span> مقالات</p>
        ...
        {card.length < 6 ? "" : <div className="flex  direction justify-center items-center gap-2 mt-12">
          ...
          <div className="flex items-center gap-1">
            <a href="#"><button id='1' onClick={change} className="min-w-[44px] h-11 rounded-xl text-sm font-medium transition-all duration-300 bg-[#161616] text-neutral-400 border border-[#262626] hover:border-orange-500/50 hover:text-white">1</button>  </a>
          
            <a href="#"><button id='2' onClick={changeTwo} className="min-w-[44px] h-11 rounded-xl text-sm font-medium transition-all duration-300 bg-[#161616] text-neutral-400 border border-[#262626] hover:border-orange-500/50 hover:text-white">2</button></a>
           <a href="#"> <button id='3' onClick={changeThree} className="min-w-[44px] h-11 rounded-xl text-sm font-medium transition-all duration-300 bg-[#161616] text-neutral-400 border border-[#262626] hover:border-orange-500/50 hover:text-white">3</button></a>
            <a href="#"><button id='4' onClick={changefour} className="min-w-[44px] h-11 rounded-xl text-sm font-medium transition-all duration-300 bg-[#161616] text-neutral-400 border border-[#262626] hover:border-orange-500/50 hover:text-white">4</button></a>
           <a href="#"> <button id='5' onClick={displayfive} className="min-w-[44px] h-11 rounded-xl text-sm font-medium transition-all duration-300 bg-[#161616] text-neutral-400 border border-[#262626] hover:border-orange-500/50 hover:text-white">5</button></a>
          </div>
          <button className="p-3 rounded-xl border transition-all duration-300 bg-[#161616] border-[#262626] text-white hover:border-orange-500/50 hover:bg-[#1a1a1a]">
            <svg className="w-5   h-5 rotate-180" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 5l7 7-7 7"></path></svg></button>
        </div>
         }
        
        {card.length < 6 ? "" : <p className="text-center text-neutral-500 mt-4 text-sm">صفحة {currentPage} من 5</p>}
      </div>
    </div>
